const Footer = () =>{
    return (
        <footer className="footer sm:footer-horizontal bg-gray-900 text-gray-300 p-5 mt-10 fixed bottom-0">
  <aside>
    <svg
      width="50"
      height="50"
    ...
    <p className="text-lg font-semibold text-white">devTinder</p>
